...
In short, Linux Arver had some excellent instructions for installing Arch onto a LVM ecrypted filesystem.  However, I wanted a few tweaks, and some of these had to change for installing into a VM.  In addition, I like the idea of a couple of scripts to prevent typos. :)
